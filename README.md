...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mt284zy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mt284zy.containers.anotherwebservice.com/
...
```
git clone git@github.com:lodyga/container-mt284zy.git
cd container-mt284zy
```
...
```
docker attach container-mt284zy
```
